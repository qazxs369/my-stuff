...
* return it. For conversion and rounding, check the notes in the text below.
...
* to the argument. The result is rounded to an integer by adding 1/2, taking
* the floor of the result after adding 1/2, and typecasting the result to type
...
NOTE: All methods should be defined as public static like we have been doing so
* far in the course.
...
public class _10_CodingExercise1_SpeedConverter {

    public static void main (String[] args){
        printConversion(1.50);
        printConversion(10.25);
        printConversion(-5.60);
