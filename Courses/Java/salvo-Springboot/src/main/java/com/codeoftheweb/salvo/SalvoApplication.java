...
public class SalvoApplication {
    ...
    public CommandLineRunner initData(PlayerRepository playerRepository, GameRepository gameRepository, GamePlayerRepository gamePlayerRepository, ShipRepository shipRepository, SalvoRepository salvoRepository, ScoreRepository scoreRepository) {
        return (args) -> {
            ...
            Game g4 = new Game(Date.from(date.toInstant().plusSeconds(7201)));
            Game g5 = new Game(Date.from(date.toInstant().plusSeconds(7202)));
            Game g6 = new Game(Date.from(date.toInstant().plusSeconds(7203)));
            Game g7 = new Game(Date.from(date.toInstant().plusSeconds(7204)));
            Game g8 = new Game(Date.from(date.toInstant().plusSeconds(7205)));
            ...
            /*------- CREO SCORES -------*/
            Score sc1 = new Score(g1, p1, 1.0, date);
            Score sc2 = new Score(g1, p2, 0.0, date);
            Score sc3 = new Score(g2, p1, 0.5, date);
            Score sc4 = new Score(g2, p2, 0.5, date);
            Score sc5 = new Score(g3, p2, 1.0, date);
            Score sc6 = new Score(g3, p4, 0.0, date);
